						...
						<form class="form-horizontal" action="<?php echo base_url();?>save-product" method="POST" enctype='multipart/form-data'>
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="product_name" id="brand_name" value="<?php echo $products_info->product_name?>" >								
							  </div>
							</div>			
         			<div class="control-group">
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="1" name="product_short_description"><?php echo $products_info->product_short_description;?> </textarea>
							  </div>
							</div>
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Product Description</label>
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="2" name="product_long_description"><?php echo $products_info->product_long_description;?></textarea>
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Product Price </label>
							  <div class="controls">
								<input type="number" class="span6 typeahead" name="product_price" value="<?php echo $products_info->product_price;?>">								
							  </div>
							</div>	
							<div class="control-group">
							  <label class="control-label" for="typeahead">Product Quantity </label>
							  <div class="controls">
								<input type="number" class="span6 typeahead" name="product_quantity" value="<?php echo $products_info->product_quantity;?>">								
							  </div>
							</div>	
							<div class="control-group">
							  <label class="control-label" for="typeahead">Product Sale Price </label>
							  <div class="controls">
								<input type="number" class="span6 typeahead" name="product_sale_price" value="<?php echo $products_info->product_sale_price;?>">								
							  </div>
							</div>	
							<div class="control-group">
