...
<body>
    ...
    <script src="assets/js/jquery.assets/js"></script>
	<script src="assets/js/bootstrap.min.assets/js"></script>
	<script src="assets/js/jquery.scrollUp.min.assets/js"></script>
	<script src="assets/js/price-range.assets/js"></script>
    <script src="assets/js/jquery.prettyPhoto.assets/js"></script>
    <script src="assets/js/main.assets/js"></script>
</body>
</html>